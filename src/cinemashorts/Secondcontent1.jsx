      ...
      <div className="col mt-5 pe-5" >
            <div className="row " style={{borderBottom:"2px solid rgba(190, 185, 185, 0.838)"}}>
                <div className="d-flex justify-content-between align-item-center">
                    <h5 className="fw-bold "  >விளையாட்டு</h5> 
                    <p className="my-auto" style={{fontSize:"12px"}}>மேலும் படிக்க &nbsp;<i className="fa-solid fa-greater-than" style={{fontSize:"10px"}}></i></p>                  
                    </div>
            </div>
            <div className="row  row-cols-3  row-cols-sm-3 row-cols-md-3 mt-2 row-cols-xl-3 row-cols-xxl-3 mx-auto" >
                <div className="col" >
                <i className="fa-solid fa-ellipsis ps-5 pointer" ></i>
